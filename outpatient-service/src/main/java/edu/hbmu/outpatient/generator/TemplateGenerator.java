package edu.hbmu.outpatient.generator;
...
public class TemplateGenerator {
    ...
    public static void main(String[] args) {
        ...
        String outputDir = projectPath + "/outpatient-service/src/main/java";
        ...
        packageConfigBuilder.parent("edu.hbmu.outpatient");//设置父包
        ...
        // 设置需要映射的表名
        strategyConfigBuilder.addInclude("department", "doctor","diagnosis", "disease", "medicine", "patient");
