package edu.hbmu.cooperation.generator;
...
public class TemplateGenerator {
    ...
    public static void main(String[] args) {
        ...
        DataSourceConfig.Builder dataSourceConfigBuilder = new DataSourceConfig
                .Builder(
                "jdbc:mysql://localhost:3306/medi_mind",
                "root",
                "123456");
        ...
        String outputDir = projectPath + "/cooperation-service/src/main/java";
        ...
        packageConfigBuilder.parent("edu.hbmu.cooperation");//设置父包
        packageConfigBuilder.entity("domain.entity");//自定义实体包名(不同的模块自己手动修改)
        ...
        // 设置需要映射的表名
//        strategyConfigBuilder.addInclude("communication_session", "msg_info", "group_info", "group_member");
        strategyConfigBuilder.addInclude("schedule");
